...
class VisaInvitationPDF(object):
    ...
    def _build_pdf(self, canvas):
        ...
        <img src="%s/client/img/signature.png" valign="middle" width="100" height="30"/>
        ...
        canvas.drawImage("%s/client/img/ecmwf_footer.png" %
...
class VisaInvitation(RHRegistrationsActionBase):
    ...
    def _process(self):
        ...
        form = VisaInvitationForm(regform=self.regform, registration_id=registration_ids,
